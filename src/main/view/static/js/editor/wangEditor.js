(function (global, factory) {
    ...
    */
    ...
    var config = {
        ...
        fontNames: ['微软雅黑', '宋体', 'Arial', 'Tahoma', 'Verdana'],
    ...
    Editor.prototype = {
        ...
        _initDom: function _initDom() {
            ...
            if (textSelector == null) {
                ...
                // 自行创建的，需要配置默认的样式
                $toolbarElem.css('background-color', '#fff').css('border-bottom', '1px solid #ccc');
                $textContainerElem.css('border', '1px solid #fff').css('border-top', 'none').css('height', '500px');
            } else {
